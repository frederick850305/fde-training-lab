...
export const menu = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Location Inventory', page: 'stock-items' },
      { label: 'Stock Transactions', page: 'transactions' },
      { label: 'Transfer Documents', page: 'transfer-documents' },
      { label: 'Forecast Stock Requirements', page: 'wanted' },
    ],
  },
  {
    label: 'Purchase',
    items: [
      ...
      { label: 'Requisitions', page: 'forms' },
      { label: 'Queries', page: 'forms' },
      { label: 'Quotations', page: 'quotations' },
      { label: 'Quotation Comparison', page: 'quotation-comparison' },
      { label: 'Purchase Orders', page: 'forms' },
      ...
      { label: 'Claims', page: 'quality-checks' },
      { label: 'Contracts', page: 'contracts' },
      { label: 'Custom Clearance Contracts', page: 'contracts' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Budget Overview', page: 'budgets' },
      { label: 'Budget Specification', page: 'budgets' },
      { label: 'Budget Breakdown', page: 'budgets' },
      { label: 'Budget Prognosis', page: 'budgets' },
      { label: 'Budget Hierarchy', page: 'budgets' },
