...
export const db = reactive({
  ...
  componentTypes: [
    { id: uid('ct'), typeNumber: 'CT-1001', name: 'Main Engine Cylinder Liner', maker: 'Wärtsilä', model: 'RT-flex', type: 'Liner', classCode: 'ENG', compTypeModel: 'RT-flex82T', status: 'Active', preferredVendor: 'Wärtsilä Marine', parentTypeNumber: '', description: 'Main Engine cylinder liner assembly for low-speed 2-stroke engines', dateCreated: '2022-01-15', dateModified: '2024-06-10', jobs: 4, counters: [
  ...
  stockTypes: [
    { id: uid('st'), stockTypeNo: 'ST-101', description: 'Cylinder Liner Gasket', maker: 'Wärtsilä', makersRef: '1698466', parentTypeNo: '', perishable: false, stockClass: 'Spare Part', vendor: 'Wärtsilä Marine', grade: 'A', unit: 'pcs', bestPrice: 320, status: 'Active' },
    { id: uid('st'), stockTypeNo: 'ST-102', description: 'Piston Ring Set', maker: 'Wärtsilä', makersRef: '79613003', parentTypeNo: '', perishable: false, stockClass: 'Spare Part', vendor: 'Wärtsilä Marine', grade: 'A', unit: 'set', bestPrice: 890, status: 'Active' },
    { id: uid('st'), stockTypeNo: 'ST-103', description: 'Cylinder Liner', maker: 'Wärtsilä', makersRef: '87971491', parentTypeNo: '', perishable: false, stockClass: 'Spare Part', vendor: 'Wärtsilä Marine', grade: 'A', unit: 'pcs', bestPrice: 4200, status: 'Active' },
